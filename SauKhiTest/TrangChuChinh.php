...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="./PluginsDung/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
        <link rel="stylesheet" href="./PluginsDung/icheck-bootstrap/icheck-bootstrap.min.css">
        <link rel="stylesheet" href="./PluginsDung/overlayScrollbars/css/OverlayScrollbars.min.css">
        <link rel="stylesheet" href="./PluginsDung/daterangepicker/daterangepicker.css">
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <script src="./PluginsDung/chart.js/Chart.min.js"></script>
        <script src="./PluginsDung/sparklines/sparkline.js"></script>
        <script src="./PluginsDung/jqvmap/jquery.vmap.min.js"></script>
        <script src="./PluginsDung/jqvmap/maps/jquery.vmap.usa.js"></script>
        <script src="./PluginsDung/jquery-knob/jquery.knob.min.js"></script>
        <script src="./PluginsDung/moment/moment.min.js"></script>
        <script src="./PluginsDung/daterangepicker/daterangepicker.js"></script>
        <script src="./PluginsDung/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
        ...
        <script type="text/javascript">$(function(){$('.textarea').summernote()})</script>
        <script>
